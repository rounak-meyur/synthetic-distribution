...
do
    ...
    echo "#SBATCH -o /scratch/rm5nz/synthetic-distribution/valid$i.out -e /scratch/rm5nz/synthetic-distribution/valid$i.err">>vjob.sbatch
    echo "module load anaconda/2019.10-py3.7">>vjob.sbatch
    echo "source activate rounak">>vjob.sbatch
    echo "python distnw-sbatch-validate.py $i">>vjob.sbatch
    sbatch vjob.sbatch
    rm vjob.sbatch
done