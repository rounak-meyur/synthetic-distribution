...
do
    ...
    do
        ...
        echo "#SBATCH -o /scratch/rm5nz/synthetic-distribution/compnet${i}_ens${j}.out -e /scratch/rm5nz/synthetic-distribution/compnet${i}_ens${j}.err">>compjob.sbatch
        echo "module load anaconda/2019.10-py3.7">>compjob.sbatch
        echo "source activate rounak">>compjob.sbatch
        echo "python sbatch-haussdorff.py $i $j">>compjob.sbatch
