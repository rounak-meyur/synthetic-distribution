...
axins = zoomed_inset_axes(ax, 16, loc=2)
subind = 1041#int(sys.argv[1])
sub = sublist[subind]

axins.scatter(subs.cord[sub][0],subs.cord[sub][1],s=5000.0,c='magenta',
              marker='*')
...
axins.scatter(xpts,ypts,s=100.0,c=color_list[subind])
